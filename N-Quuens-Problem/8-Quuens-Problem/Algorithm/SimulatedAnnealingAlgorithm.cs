    ...
    public class SimulatedAnnealingAlgorithm : Utilities
    {
        ...
        public void SolveProblem(Chessboard chessboard, int temperature, int coolingFactor)
        {
            ...
            while (temperature>0 && heuristic>0)
            {
                ...
                {
                    CheckIfMoveShouldBeSaved(queensPlacement, randomQueen, queensStartPlacement, temperature, changedHeuristic);
                }
        ...
        private void CheckIfMoveShouldBeSaved(int[] queensPlacement, int randomQueen, int queensStartPlacement, int temperature, int changedHeuristic)
        {
